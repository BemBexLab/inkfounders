...
const HomeHero = () => {
  ...
  return (
    <section className="relative flex w-full items-center justify-center overflow-x-hidden rounded-bl-[36px] bg-[#F4F3E1] py-8 sm:rounded-bl-[56px] sm:py-10 lg:rounded-bl-[100px] lg:py-12">
      <style jsx global>{`
        @keyframes slideIn {
          0% {
      ...
      <div className="relative z-10 mx-auto w-full px-4 sm:px-6 md:px-10 lg:hidden">
        <div className="mx-auto flex w-full max-w-3xl flex-col items-start gap-5 pb-10">
          ...
          >
            Ink Founders is a self-publishing company USA authors trust for a complete suite of digital publishing services. From your first idea to your finished, published book, we support you at every stage of your self-publishing journey. Let's bring your story to life; reach out to us today.
          </p>

          <div className="flex w-full flex-row justify-center gap-2 sm:gap-3">
            <a href="tel:+14702052227" className="min-w-0 flex-1 sm:flex-none">
              <button
                type="button"
      ...
      <div className="relative z-10 mx-auto hidden w-full max-w-[1450px] px-4 sm:px-6 md:px-8 lg:block lg:px-10 xl:px-0">
        <div className="flex flex-col items-center justify-between gap-10 sm:gap-12 lg:flex-row lg:gap-0">
          <div className="flex min-w-0 flex-1 flex-col items-center justify-center px-0 md:ml-0 md:px-1 lg:items-start xl:ml-20">
          ...
          <div className="relative flex min-w-0 flex-1 items-center justify-center px-2 sm:px-4 md:px-8 lg:ml-5">
            <div className="pointer-events-none absolute inset-0 z-0 flex items-center justify-center">
              <Image
                src="/Home/bookslidetest/Ellipse 2.webp"
                alt="Decorative background"
