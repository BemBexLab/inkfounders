    ...
    <div className="bg-white py-20 px-8">
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="text-center mb-16">
          <p className="text-[20px] text-[#000000] mb-2">Testimonials</p>
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((t) => (
                ...
                >
                  <div className="bg-white rounded-2xl p-8 max-w-[360px] mx-auto shadow-sm">
                    {/* Quote Icon */}
                    <div className="w-12 h-12 bg-[#e8e55f] rounded-full flex items-center justify-center mb-6">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[13px] text-[#666666]">{t.role}</p>
                      </div>
                    </div>
                  </div>
                </div>
