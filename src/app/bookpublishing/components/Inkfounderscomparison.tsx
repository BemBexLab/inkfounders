      ...
      >
        <div className="w-full">
          <motion.div className="text-center" variants={containerVariants}>
            <motion.p
              className="mb-2 text-xs font-semibold uppercase tracking-[0.25em] text-gray-400 sm:text-sm md:text-md"
            ...
            <motion.p
              className="mx-auto max-w-7xl text-sm leading-relaxed text-gray-500 sm:text-base lg:text-lg"
                ...
                >
                  {logoPaths.map((path, index) => (
                    <path
                      key={index}
                      d={path}
                      fill={index === logoPaths.length - 4 ? "#DADD39" : "#F4F3E1"}
                    />
                  ))}
                </svg>
              </motion.div>
                  ...
                  >
                    {row.ink.yellow ? (
                      ...
                      <span style={{ fontSize: "clamp(0.55rem, 1.4vw, 0.99rem)", lineHeight: 1.3 }}>
                        <span style={{ color: "#DADD39", fontWeight: 400 }}>{CHECK_MARK} </span>
