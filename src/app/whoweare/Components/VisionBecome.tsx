...
export default function VisionBecome() {
  return (
    <section className="w-full bg-[#F6F5F3] py-12 sm:py-16 lg:py-20">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center justify-center gap-8 px-4 sm:px-6 md:px-8 lg:grid-cols-[auto_minmax(0,1fr)] lg:gap-10 lg:px-4">
        {/* Book Cover */}
        ...
        {/* Content */}
        <div className="mx-auto flex max-w-2xl flex-col gap-4 text-center lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:mx-0 lg:justify-center lg:text-left">
          <h2 className="text-2xl font-semibold text-black md:text-[27px]">
          ...
          >
            ...
            <p>
              Trust and quality sit at the center of everything we do. We work selectively with authors who share our values of respect, excellence, and purpose, and we bring the same level of creativity and care to every project, protecting your voice while delivering results across writing, design, and narration.
            </p>
          </div>
        </div>
      </div>
