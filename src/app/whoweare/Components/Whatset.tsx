      ...
      <section className="flex w-full items-center justify-center bg-[#F6F5F3] px-4 py-10 sm:px-6 md:px-8">
        <div className="flex w-full max-w-[1300px] flex-col items-center">
          ...
          <div className="mx-auto mb-10 max-w-6xl">
            ...
            >
              Ink Founders isn't just another name on a list of self-publishing companies; we act as creative partners in turning your ideas into a publishable story. Working with us means personalized support and a team that's genuinely invested in your book, not just processing it through a pipeline.
            </p>
          </div>
